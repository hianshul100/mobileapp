# SkillForge Final Project Submission

Project Title: `SkillForge`

## 1. Public GitHub Repository

URL: `https://github.com/hianshul100/mobileapp`

Title: `SkillForge Flutter Mobile App`

Caption: `Public GitHub repository for the SkillForge Flutter/Dart mobile application.`

## 2. User Stories Markdown
...
Upload file: `flutter_mobile_app/evidence/figma-evidence1.png`

## 4. Figma Evidence 2

Upload file: `flutter_mobile_app/evidence/figma-evidence2.png`
...
Caption: `Flutter/Dart signup screen with username, email, password validation, local persistence, and navigation.`

## 6. Signup Screen Evidence

Upload file: `flutter_mobile_app/evidence/signup_screen_evidence.png`

## 7. Signup Error Evidence

Upload file: `flutter_mobile_app/evidence/signup_error.png`

## 8. Login Implementation
...
## 9. Login Screen Evidence

Upload file: `flutter_mobile_app/evidence/login_screen_evidence.png`

## 10. Login Error Evidence

Upload file: `flutter_mobile_app/evidence/login_error.png`

## 11. Home Screen Implementation
...
## 12. Home Screen Evidence

Upload file: `flutter_mobile_app/evidence/home-screen-evidence.png`
...
Caption: `Flutter/Dart detail screen displaying selected lesson information and favorite persistence action.`

## 14. Detail Navigation Evidence

Upload file: `flutter_mobile_app/evidence/evidence-detail-navigation.png`

## 15. Detail Screen Evidence

Upload file: `flutter_mobile_app/evidence/evidence-detail-screen.png`

## 16. Local Storage Implementation
...
Upload file: `flutter_mobile_app/evidence/evidence-persistence.png`

## 18. Integrated Persistence Evidence

Upload file: `flutter_mobile_app/evidence/evidence-integrateScreen-persistence.png`
...
Upload file: `flutter_mobile_app/evidence/evidence-api-ux.png`
...
Caption: `Flutter/Dart settings menu screen with profile, settings, and notifications menu items.`

## 22. Settings Menu Icon Evidence

Upload file: `flutter_mobile_app/evidence/evidence-menu-icon.png`

## 23. Settings Menu Items Evidence

Upload file: `flutter_mobile_app/evidence/evidence-menu-items.png`

## 24. Settings Screen Implementation
...
## 25. Settings Screen Evidence

Upload file: `flutter_mobile_app/evidence/evidence-settings-screen.png`

## 26. Notifications Implementation
...
## 27. Notification Configure Evidence

Upload file: `flutter_mobile_app/evidence/evidence-notification-configure.png`
